// index.js - Servidor Express completo y funcional
...
// 3. Enviar regalo (VERSIÓN CON LOGS DETALLADOS)
  ...
  try {
   ...
   // Obtener precio del catálogo
      ...
      for (const store of catalogResponse.data.storefronts) {
        if (store.catalogEntries) {
          ...
          if (entry) {
            ...
            // Nueva lógica para extraer el precio (Soporta el formato nuevo y el viejo)
    ...
    const payload = {
      ...
      giftWrapTemplateId: 'GiftBox:gb_default', // Con 'gb_' en minúsculas
